            ...
            <form id="fib" action="tugasphp">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-12 text-center form-control overflow-auto">
                           <?php
                           $a = 0;
                           $b = 1;
                           for($i= 0;$i < $num ; $i++){
                    ...
                    <button type="submit" name="fibosub" value="fiboSub" class="btn btn-primary mt-4">Reset</button>

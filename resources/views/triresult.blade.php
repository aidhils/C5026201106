    ...
    <!-- Fibonacci  -->
       ...
       <div class="row mx-auto pt-5">
        ...
        <div class="col-sm-10">
            ...
            <form id="tri" action="tugasphp">
                @csrf
                <div class="form-group row">

                    <div class="col-sm-3">
                    <label for="startnum" class="col-sm-12 col-form-label text-center ml-1" >
                           Number of row
                        </label>
                        <div class="col-sm-12 text-center form-control ml-1">
                                    <?php
                                           $row = $_POST["numtri"];
                                    echo($row)
                                    ?>
                     ...
                     <div class="col-sm-6 tri overflow-hidden">
                     <!-- Display of triangle -->
                     <?php
                     ...
                     <div class="col-sm-2 mt-3">
                        ...
                        <button type="submit" name="trisub" value="triSub" class="btn btn-primary  mt-4">Reset</button>

       ...
       <!-- Symbol -->
        <div class="row mx-auto pt-5">
                ...
                <div class="col-sm-10">
                    ...
                    <form id="ftoc" class="mt-4" action="revresult" method="post" >
                        @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5 mt-3">
                                ...
                                <div class="col-sm-12">
                                    <input type="number" class="form-control text-center" id="clc" name="clc" placeholder="Your Temperature" >
                                    <p id="fhr-false"></p>
                                </div>
                             </div>
            ...
            <form id="fib" action="fibo" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="col-sm-12">
                            <input type="number" class="form-control" id="seq" name="seq" placeholder="How many?hundreds." min="1" max="15" >
                            <p id="seq-false"></p>
                        </div>
                     </div>
            ...
            <form id="tri" action="triangle" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="col-sm-12">
                            <input type="number" class="form-control" id="numtri" name="numtri" placeholder="Row" min="1">
                            <p id="tri-false"></p>
                        </div>
                     </div>
    ...
    $(document).ready(function(){
        ...
        // Temp Submit
         ...
         $(".tempsubmit").click(function(){
             var celcius = $("#clc").val()
             if(isNaN(celcius) == true || celcius.length <= 0){

          // isNan Jika ada yang bukan angka maka benar
                $("#clc").css({'border' : '2px solid red'})

       ...
       <!-- Symbol -->
        <div class="row mx-auto pt-5">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="col-sm-3">
                        <label for="dice1" class="col-sm-12 col-form-label text-center" >
                            Dice 1
                        </label>
                    ...
                    <i class="fa fa-plus" aria-hidden="true" style="font-size:3em";></i>
                    </div>

                     <div class="col-sm-3">
                        <label for="dice2" class="col-sm-12 col-form-label text-center" >
                            Dice 2
                        </label>
                        <div class="col-sm-12 text-center form-control">
                           <?php
                    ...
                    <div class="col-sm-1 text-center mt-auto">
                    <i class="fa fa-arrow-circle-right" aria-hidden="true" style="font-size:3em"></i>
                    </div>

                    <!-- Result -->
                    <div class="col-sm-4">
                        <p class="result col-sm-12 text-center res">Result</p>
                        <div class="col-sm-12 text-center form-control">
                           <?php
                           $result = $dice1 + $dice2;
                           echo($result)

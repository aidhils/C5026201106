...
label,h1,h3,.fa{
 ...
 .text-center{
    ...
    <body>
    <div class="container mx-auto mt-2 pb-5 ">

        <h1 class="pt-5">Welcome to Compute!</h1>
       ...
       <!-- Symbol -->
        <div class="row mx-auto pt-5">
                ...
                <div class="col-sm-10">
                    ...
                    <form id="ftoc" class="mt-4" formmethod="post" action="tugasphprev">
                        @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                             ...
                             <div class="col-sm-2 text-center mt-auto">
                                ...
                                <button type="submit" name="tempsub" value="tempSub" class="btn btn-primary">Reset</button>
                             </div>
